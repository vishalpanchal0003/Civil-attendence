...
import { registerAdmin } from "../../../services/auth.api";
...
const Register = () => {
    ...
    const registerMutation = useMutation({
        mutationFn: (userData) => registerAdmin(userData),
        onSuccess: (data) => {
                    ...
                    <form onSubmit={handleRegister} className="space-y-5 lg:space-y-6">
                        ...
                        <div className="space-y-5 lg:grid lg:grid-cols-2 lg:gap-5">
                            ...
                            <div>
                                <label
                                    htmlFor="mobile"
                                    className="block text-sm lg:text-base font-semibold text-slate-700 mt-[-10px]"
                                >
                                    Mobile Number
                                </label>
                                <input
